...
<body class="bg-classroom min-h-screen overflow-hidden">
    <main class="min-h-screen flex">
        <section class="hidden lg:flex w-1/2 relative items-center justify-center p-12">
            <div class="relative z-10 w-full max-w-lg bg-white/10 backdrop-blur-md glass-border rounded-2xl p-12 shadow-2xl">
            ...
            <div class="w-full max-w-md">
                <div class="bg-white/95 backdrop-blur-xl rounded-2xl p-8 md:p-10 shadow-2xl">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <button type="submit" class="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-sm">
                            Log In
