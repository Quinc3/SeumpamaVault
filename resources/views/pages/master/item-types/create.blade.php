...
<div class="flex justify-between items-end mb-8">
    <div>
        ...
        <h2 class="text-4xl font-extrabold">Tambah Kategori Barang</h2>
    </div>
</div>

<form action="{{ route('item-types.store') }}" method="POST" class="page-card p-8 rounded-3xl shadow-sm max-w-2xl">
    @csrf
